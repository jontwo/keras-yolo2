...
class FullYoloFeature(BaseFeatureExtractor):
    ...
    def __init__(self, input_size):
        ...
        # Layer 21
        skip_connection = Conv2D(64, (1, 1), strides=(1, 1), padding='same', name='conv_21',
...
class TinyYoloFeature(BaseFeatureExtractor):
    ...
    def __init__(self, input_size):
        ...
        # Layer 1
        x = Conv2D(16, (3, 3), strides=(1, 1), padding='same', name='conv_1', use_bias=False)(
            input_image)
        x = BatchNormalization(name='norm_1')(x)
        x = LeakyReLU(alpha=0.1)(x)
        x = MaxPooling2D(pool_size=(2, 2))(x)
        ...
        # Layer 7 - 8
        for i in range(0, 2):
            x = Conv2D(1024, (3, 3), strides=(1, 1), padding='same', name='conv_' + str(i + 7),
                       use_bias=False)(x)
