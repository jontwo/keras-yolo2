...
class BatchGenerator(Sequence):
    def __init__(self, images,
        ...
        self.anchors = [BoundBox(0, 0, config['ANCHORS'][2 * i], config['ANCHORS'][2 * i + 1]) for i
        ...
        self.aug_pipe = iaa.Sequential(
            [
                ...
                sometimes(iaa.Affine(
                    ...
                    # use any of scikit-image's warping modes (see 2nd image from the top for
                    # examples)
                    # mode=ia.ALL
                )),
                ...
                iaa.SomeOf((0, 5),
                           [
                               ...
                               # sometimes(iaa.Superpixels(p_replace=(0, 1.0), n_
                               # segments=(20, 200))),
                               iaa.OneOf([
    ...
    def __getitem__(self, idx):
        ...
        x_batch = np.zeros(
            (r_bound - l_bound, self.config['IMAGE_H'], self.config['IMAGE_W'], 3))  # input images
